...
import com.pato.tresenrayagame.app.Constantes;
import com.pato.tresenrayagame.model.Jugada;
import com.pato.tresenrayagame.model.User;
...
public class GameActivity extends AppCompatActivity {
    ...
    private void updateUI() {
        for (int i=0; i<9; i++){
            ...
            if (casilla == 0) {
                ...
                ivCasillaActual.setImageResource(R.drawable.ic_jugador_uno);
            } else {
                ivCasillaActual.setImageResource(R.drawable.ic_jugador_dos);
            }
        }
    ...
    private void actualizarJugada(String numeroCasilla) {
        ...
        if (jugada.getCeldasSeleccionadas().get(posicionCasilla) != 0) {
            ...
            if (jugada.isTurnoJugadorUno()){
                casillas.get(posicionCasilla).setImageResource(R.drawable.ic_jugador_uno);
                jugada.getCeldasSeleccionadas().set(posicionCasilla, 1);
            } else {
                casillas.get(posicionCasilla).setImageResource(R.drawable.ic_jugador_dos);
    ...
    public void mostrarDialogoGameOver(){
        ...
        //Obtenemos referencias a nuestros components de nuestro layout
        ...
        if (ganadorId.equals("Empate")) {
            ...
            tvInformacion.setText("¡" + nombreJugador + " QUE BIEN! Has ganado !");
            tvPuntos.setText("+3 puntos");
        }else {
            actualizarPuntuacion(0);
            tvInformacion.setText("¡" + nombreJugador + " Has sido malo... Ya perdiste, esfuerzate más para conseguir puntos!");
            tvPuntos.setText("0 puntos");
            gameOverAnimation.setAnimation("perdedor.json");
        }
